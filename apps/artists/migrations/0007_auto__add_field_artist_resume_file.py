...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.resume_file'
        db.add_column(u'artists_artist', 'resume_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.resume_file'
        db.delete_column(u'artists_artist', 'resume_file')
