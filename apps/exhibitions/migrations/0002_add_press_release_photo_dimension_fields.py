...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibition.press_release_photo_height'
        db.add_column(u'exhibitions_exhibition', 'press_release_photo_height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.press_release_photo_width'
        db.add_column(u'exhibitions_exhibition', 'press_release_photo_width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exhibition.press_release_photo_height'
        db.delete_column(u'exhibitions_exhibition', 'press_release_photo_height')

        # Deleting field 'Exhibition.press_release_photo_width'
        db.delete_column(u'exhibitions_exhibition', 'press_release_photo_width')
