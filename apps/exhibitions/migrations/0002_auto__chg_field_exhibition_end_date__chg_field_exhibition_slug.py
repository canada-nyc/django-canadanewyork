...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibition.end_date'
        db.alter_column('exhibitions_exhibition', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Exhibition.slug'
        db.alter_column('exhibitions_exhibition', 'slug', self.gf('^apps\\.slugify\\.fields\\.SlugifyField')(max_length=50, populate_from=('name',)))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Exhibition.end_date'
        raise RuntimeError("Cannot reverse this migration. 'Exhibition.end_date' and its values cannot be restored.")

        # Changing field 'Exhibition.slug'
        db.alter_column('exhibitions_exhibition', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
