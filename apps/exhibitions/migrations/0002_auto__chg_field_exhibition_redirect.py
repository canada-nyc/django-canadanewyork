...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibition.redirect'
        db.alter_column('exhibitions_exhibition', 'redirect_id', self.gf('libs.content_redirects.fields.RedirectField')(null=True, new_path=None, on_delete=models.SET_NULL, site=None, to=orm['redirects.Redirect'], unique=True, old_path=None))

    def backwards(self, orm):

        # Changing field 'Exhibition.redirect'
        db.alter_column('exhibitions_exhibition', 'redirect_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['redirects.Redirect'], unique=True, null=True))
