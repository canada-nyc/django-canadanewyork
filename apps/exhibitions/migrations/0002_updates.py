...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibition.redirect'
        db.add_column('exhibitions_exhibition', 'redirect',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['redirects.Redirect'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.old_path'
        db.add_column('exhibitions_exhibition', 'old_path',
                      self.gf('apps.content_redirects.fields.RedirectOldPathField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exhibition.redirect'
        db.delete_column('exhibitions_exhibition', 'redirect_id')

        # Deleting field 'Exhibition.old_path'
        db.delete_column('exhibitions_exhibition', 'old_path')
