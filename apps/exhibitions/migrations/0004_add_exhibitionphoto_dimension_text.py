...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExhibitionPhoto.dimensions_text'
        db.add_column(u'exhibitions_exhibitionphoto', 'dimensions_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


        # Changing field 'ExhibitionPhoto.height'
        db.alter_column(u'exhibitions_exhibitionphoto', 'height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ExhibitionPhoto.depth'
        db.alter_column(u'exhibitions_exhibitionphoto', 'depth', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

        # Changing field 'ExhibitionPhoto.width'
        db.alter_column(u'exhibitions_exhibitionphoto', 'width', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4))

    def backwards(self, orm):
        # Deleting field 'ExhibitionPhoto.dimensions_text'
        db.delete_column(u'exhibitions_exhibitionphoto', 'dimensions_text')


        # Changing field 'ExhibitionPhoto.height'
        db.alter_column(u'exhibitions_exhibitionphoto', 'height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'ExhibitionPhoto.depth'
        db.alter_column(u'exhibitions_exhibitionphoto', 'depth', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'ExhibitionPhoto.width'
        db.alter_column(u'exhibitions_exhibitionphoto', 'width', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))
