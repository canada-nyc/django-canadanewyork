...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExhibitionPhoto.date'
        db.add_column(u'exhibitions_exhibitionphoto', 'date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExhibitionPhoto.date'
        db.delete_column(u'exhibitions_exhibitionphoto', 'date')
