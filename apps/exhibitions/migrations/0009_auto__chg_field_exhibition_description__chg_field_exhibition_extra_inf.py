...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'exhibitions_exhibition', 'description', self.gf('libs.ckeditor.fields.CKEditorField')())

        # Changing field 'Exhibition.extra_info'
        db.alter_column(u'exhibitions_exhibition', 'extra_info', self.gf('libs.ckeditor.fields.CKEditorField')())

    def backwards(self, orm):

        # Changing field 'Exhibition.description'
        db.alter_column(u'exhibitions_exhibition', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Exhibition.extra_info'
        db.alter_column(u'exhibitions_exhibition', 'extra_info', self.gf('django.db.models.fields.TextField')())
