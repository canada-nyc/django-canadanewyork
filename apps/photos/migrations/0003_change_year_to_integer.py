...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.medium'
        db.alter_column(u'photos_photo', 'medium', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Photo.year'
        db.alter_column(u'photos_photo', 'year', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photo.medium'
        db.alter_column(u'photos_photo', 'medium', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'Photo.year'
        db.alter_column(u'photos_photo', 'year', self.gf('django.db.models.fields.CharField')(default='', max_length=400))
