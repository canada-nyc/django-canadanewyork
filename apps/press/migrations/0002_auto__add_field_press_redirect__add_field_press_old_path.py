...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Press.redirect'
        db.add_column('press_press', 'redirect',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['redirects.Redirect'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Press.old_path'
        db.add_column('press_press', 'old_path',
                      self.gf('apps.content_redirects.fields.RedirectOldPathField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Press.redirect'
        db.delete_column('press_press', 'redirect_id')

        # Deleting field 'Press.old_path'
        db.delete_column('press_press', 'old_path')
