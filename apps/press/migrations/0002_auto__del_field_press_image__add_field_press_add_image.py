...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('press_press', 'image')

        # Adding field 'Press.add_image'
        db.add_column('press_press', 'add_image',
    ...
    def backwards(self, orm):
        ...
        db.add_column('press_press', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Press.add_image'
        db.delete_column('press_press', 'add_image')
