...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Press.redirect'
        db.alter_column('press_press', 'redirect_id', self.gf('libs.content_redirects.fields.RedirectField')(null=True, new_path=None, on_delete=models.SET_NULL, site=None, to=orm['redirects.Redirect'], unique=True, old_path=None))

    def backwards(self, orm):

        # Changing field 'Press.redirect'
        db.alter_column('press_press', 'redirect_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['redirects.Redirect'], unique=True, null=True))
    ...
    models = {
        'artists.artist': {
            ...
            'redirect': ('libs.content_redirects.fields.RedirectField', [], {'null': 'True', 'new_path': 'None', 'on_delete': 'models.SET_NULL', 'site': 'None', 'to': "orm['redirects.Redirect']", 'blank': 'True', 'unique': 'True', 'old_path': 'None'}),
        ...
        'press.press': {
            ...
            'add_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'redirect': ('libs.content_redirects.fields.RedirectField', [], {'null': 'True', 'new_path': 'None', 'on_delete': 'models.SET_NULL', 'site': 'None', 'to': "orm['redirects.Redirect']", 'blank': 'True', 'unique': 'True', 'old_path': 'None'}),
            'slug': ('libs.slugify.fields.SlugifyField', [], {'max_length': '50', 'populate_from': "('title',)"}),
