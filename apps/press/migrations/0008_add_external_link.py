...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Press.content_link'
        db.add_column(u'press_press', 'content_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Press.content_link'
        db.delete_column(u'press_press', 'content_link')
    ...
    models = {
        ...
        u'press.press': {
            ...
            'content_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
