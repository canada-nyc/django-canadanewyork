...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Update.slug'
        db.delete_column('updates_update', 'slug')

        # Deleting field 'Update.name'
        db.delete_column('updates_update', 'name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Update.slug'
        raise RuntimeError("Cannot reverse this migration. 'Update.slug' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Update.name'
        raise RuntimeError("Cannot reverse this migration. 'Update.name' and its values cannot be restored.")
