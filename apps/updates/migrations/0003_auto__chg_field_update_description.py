...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'updates_update', 'description', self.gf('libs.ckeditor.fields.CKEditorField')())

    def backwards(self, orm):

        # Changing field 'Update.description'
        db.alter_column(u'updates_update', 'description', self.gf('django.db.models.fields.TextField')())
