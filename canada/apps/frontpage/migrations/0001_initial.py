...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('frontpage_frontpage', (
            ...
            ('exhibition_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibitions.ExhibitionPhoto'], null=True, blank=True)),
    ...
    models = {
        ...
        'frontpage.frontpage': {
            ...
            'exhibition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exhibitions.Exhibition']"}),
            'exhibition_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['exhibitions.ExhibitionPhoto']", 'null': 'True', 'blank': 'True'}),
