...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Frontpage.exhibition_image'
        db.alter_column('frontpage_frontpage', 'exhibition_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibitions.ExhibitionPhoto'], null=True))
