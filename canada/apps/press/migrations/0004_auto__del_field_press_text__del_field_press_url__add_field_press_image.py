...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Press.url'
        db.delete_column('press_press', 'url')
        ...
        # Adding field 'Press.link'
        db.add_column('press_press', 'link',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Press.url'
        db.add_column('press_press', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Press.link'
        db.delete_column('press_press', 'link')
    ...
    models = {
        ...
        'press.press': {
            ...
            'image_size': ('django.db.models.fields.CharField', [], {'default': "'500x'", 'max_length': '10'}),
