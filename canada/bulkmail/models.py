...
class ContactList(models.Model):
    ...
    def save(self):
        # sets "default" to False on all other contactlists, if we enable it to on this one
        if self.default:
...
class Message(models.Model):
    def image_path(instance, filename):
        return os.path.join('bulkmail', '%s-%s' % (instance.date_time, instance.subject), filename)
