...
def model_kwargs(element, app, model):
    ...
    def object_from_photo(element, model_kwargs):
    ...
    if app == 'artists' and model == 'Artist':
        ...
        k['artists'] = artists_from_exhibition(element, model_kwargs=k)
        ...
        k['artists'] = [artist_from_press(element, model_kwargs=k), ]
        ...
        k['content_object'] = object_from_photo(element, model_kwargs=k)
